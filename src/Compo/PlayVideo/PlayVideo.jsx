...
const PlayVideo = () => {
    ...
    const [channelData, setChnnelData] = useState(null);
    ...
    const fetchOther = async () => {
        ...
        await fetch(channelData).then(res => res.json()).then(data => setChnnelData(data.items[0]))
            ...
            {apiData && (
                <>
                    ...
                    <div className='video-dis'>
                        <p>{apiData ? apiData.snippet.description.slice(0, 250) : "Here"}</p>
                        <hr />
